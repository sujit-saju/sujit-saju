...
```
Edge AI & Inference   →   TensorRT · CUDA · ONNX Runtime · OpenCV · YOLO · NVIDIA Jetson
Real-Time Systems     →   GStreamer · RTSP · HLS · MJPEG · MediaMTX · Multithreading · FSM
Languages             →   Python · C/C++ · Java · TypeScript
Backend               →   Spring Boot · REST APIs · Spring Security
Databases & Infra     →   PostgreSQL · MySQL · Docker · Git
...
#### 🔴 Distributed Edge AI Video Surveillance Platform
...
#### 📡 [RTSP Manager Server](https://github.com/sujit-saju/rtsp-manager-server)
#### 📡 [RTSP Manager UI](https://github.com/sujit-saju/rtsp-manager-ui)
...
<a href="https://linkedin.com/in/sujit-saju">LinkedIn</a> &nbsp;·&nbsp; sujsj07@gmail.com
